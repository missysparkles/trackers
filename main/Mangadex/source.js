...
const MangadexLogin_1 = require("./MangadexLogin");
...
class Mangadex extends paperback_extensions_common_1.Tracker {
    constructor() {
        super(...arguments);
        ...
        this.requestManager = createRequestManager({
            ...
            interceptor: {
                ...
                interceptRequest: (request) => __awaiter(this, void 0, void 0, function* () {
                    var _a;
                    let accessToken = yield MangadexLogin_1.getMangadexAccessToken(this.stateManager);
                    if (!request.url.includes('auth') && accessToken != null) {
                        const splitToken = accessToken.split('.');
                        const body = JSON.parse(Buffer.from(splitToken[1], 'base64').toString());
                        if (Date.now() / 1000 > body.exp) {
                            yield MangadexLogin_1.refreshMangadex(this.stateManager, this.requestManager);
                        }
                        accessToken = (yield MangadexLogin_1.getMangadexAccessToken(this.stateManager));
                    }
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const manga of json.data) {
                ...
                const title = Object.values(mangaDetails === null || mangaDetails === void 0 ? void 0 : mangaDetails.title)[0].replace(/&#(\d+);/g, (_m, d) => String.fromCharCode(d));
                const coverFileName = manga.relationships
                    .filter((x) => x.type == 'cover_art')
                    .map((x) => { var _a; return (_a = x.attributes) === null || _a === void 0 ? void 0 : _a.fileName; })[0];
    ...
    getMangaForm(mangaId) {
        return createForm({
            sections: () => __awaiter(this, void 0, void 0, function* () {
                ...
                const username = yield MangadexLogin_1.getMangadexUsername(this.stateManager);
                if (username == null) {
                    return [
                        createSection({
                    ...
                    createSection({
                        ...
                        rows: () => __awaiter(this, void 0, void 0, function* () {
                            ...
                            return [
                                createSelect({
                                    id: 'status',
                                    value: [(_a = json.status) !== null && _a !== void 0 ? _a : 'NONE'],
            ...
            onSubmit: (values) => __awaiter(this, void 0, void 0, function* () {
                var _b, _c;
                const status = (_c = (_b = values['status']) === null || _b === void 0 ? void 0 : _b[0]) !== null && _c !== void 0 ? _c : '';
    ...
    getTrackedManga(mangaId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ].map((x) => x.replace(/&#(\d+);/g, (_m, d) => String.fromCharCode(d)));
    ...
    getSourceMenu() {
        return __awaiter(this, void 0, void 0, function* () {
            return createSection({
                ...
                rows: () => __awaiter(this, void 0, void 0, function* () {
                    var _a;
                    const accessToken = yield MangadexLogin_1.getMangadexAccessToken(this.stateManager);
                    if (accessToken != null) {
                        return [
                            createLabel({
                                id: 'userInfo',
                                label: 'Logged-in as',
                                value: (_a = (yield MangadexLogin_1.getMangadexUsername(this.stateManager))) !== null && _a !== void 0 ? _a : 'ERROR',
                            }),
                            createButton({
                                id: 'logout',
                                label: 'Logout',
                                value: undefined,
                                onTap: () => __awaiter(this, void 0, void 0, function* () { return MangadexLogin_1.logOut(this.stateManager); }),
                            }),
                        ];
                    }
                    else
                        return [
                            MangadexLogin_1.loginSettings(this.stateManager, this.requestManager),
                        ];
                }),
            });
        });
...
},{"./MangadexLogin":50,"buffer":3,"paperback-extensions-common":8}],50:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.loginSettings = exports.logOut = exports.loginToMangadex = exports.refreshMangadex = exports.getMangadexRefreshToken = exports.getMangadexAccessToken = exports.getMangadexUsername = void 0;
function setMangadexCredentials(stateManager, username, password) {
    return __awaiter(this, void 0, void 0, function* () {
        return Promise.all([
...
function getMangadexCredentials(stateManager) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        const username = (_a = (yield stateManager.retrieve('mangadexUsername'))) !== null && _a !== void 0 ? _a : '';
        const password = (_b = (yield stateManager.keychain.retrieve('mangadexPassword'))) !== null && _b !== void 0 ? _b : '';
        return {
            username,
            password,
        };
...
function getMangadexUsername(stateManager) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        return (_a = (yield stateManager.retrieve('mangadexUsername'))) !== null && _a !== void 0 ? _a : '';
    });
}
exports.getMangadexUsername = getMangadexUsername;
function setMangadexTokens(stateManager, token) {
    return __awaiter(this, void 0, void 0, function* () {
        return Promise.all([
            stateManager.keychain.store('mangaDexAccessToken', token === null || token === void 0 ? void 0 : token.session),
            stateManager.keychain.store('mangaDexRefreshToken', token === null || token === void 0 ? void 0 : token.refresh),
        ]);
    });
}
function getMangadexAccessToken(stateManager) {
    return __awaiter(this, void 0, void 0, function* () {
        return stateManager.keychain.retrieve('mangaDexAccessToken');
    });
}
exports.getMangadexAccessToken = getMangadexAccessToken;
function getMangadexRefreshToken(stateManager) {
    return __awaiter(this, void 0, void 0, function* () {
        return stateManager.keychain.retrieve('mangaDexRefreshToken');
    });
}
exports.getMangadexRefreshToken = getMangadexRefreshToken;
function refreshMangadex(stateManager, requestManager) {
    return __awaiter(this, void 0, void 0, function* () {
        const token = yield getMangadexRefreshToken(stateManager);
        const loginResponse = yield requestManager.schedule(createRequestObject({
        ...
        const login = typeof loginResponse.data === 'string'
            ? JSON.parse(loginResponse.data)
            : loginResponse.data;
        return setMangadexTokens(stateManager, login === null || login === void 0 ? void 0 : login.token);
    });
}
exports.refreshMangadex = refreshMangadex;
function loginToMangadex(stateManager, requestManager) {
    return __awaiter(this, void 0, void 0, function* () {
        const { username, password } = yield getMangadexCredentials(stateManager);
        const loginResponse = yield requestManager.schedule(createRequestObject({
...
exports.loginToMangadex = loginToMangadex;
...
const loginSettings = (stateManager, requestManager) => {
    return createNavigationButton({
        ...
        form: createForm({
            onSubmit(values) {
                return __awaiter(this, void 0, void 0, function* () {
                    yield setMangadexCredentials(stateManager, values.mangadexUsername, values.mangadexPassword);
                    yield loginToMangadex(stateManager, requestManager);
                });
            },
            validate() {
                return __awaiter(this, void 0, void 0, function* () {
            ...
            sections() {
                return __awaiter(this, void 0, void 0, function* () {
                    const values = yield getMangadexCredentials(stateManager);
                    return [
                        createSection({
                            id: 'information',
                            header: 'Mangadex',
